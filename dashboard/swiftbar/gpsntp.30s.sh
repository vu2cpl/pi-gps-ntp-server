...
# ----- dropdown -----
echo "---"
echo "$host  ($ref, stratum $stratum)"
echo "---"
echo "System offset: $sys_off_h | font=Menlo"
echo "RMS offset:    $rms_h | font=Menlo"
echo "Root disp.:    $root_disp_h | font=Menlo"
echo "Skew:          $skew ppm | font=Menlo"
echo "Leap:          $leap | font=Menlo"
echo "---"
echo "GPS: $fix_str — $sat_used / $sat_seen sats used | font=Menlo"
echo "---"
echo "Updated ${age}s ago"
echo "---"
echo "Refresh | refresh=true"
